...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User currentTester = userLoggedInService.getLoggedInUser();  // get the current logged-in tester
        return testRequestQueryService.findByTester(currentTester);  // get list of test requests assigned to the tester
    }
